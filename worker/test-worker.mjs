...
assert.match(pack.pay_uri, /agentic-ai-governance-pack\?wanted=true/);
assert.doesNotMatch(pack.pay_uri, /buy\.stripe\.com/);
assert.doesNotMatch(pack.note, /auto-opens/);
...
assert.match(stripeLink.note, /ZIP downloads/i);
...
assert.doesNotMatch(cardPage, /http-equiv="refresh"/);
assert.doesNotMatch(cardPage, /location\.replace/);
assert.match(cardPage, /\/v1\/pay\/scan/);
assert.match(cardPage, /agentic-ai-governance-pack\?wanted=true/);
assert.match(cardPage, /Fractional-CFO-Launch-Kit\.zip/);
assert.match(cardPage, /Fractional-COO-Launch-Kit\.zip/);
assert.match(cardPage, /Fractional-CTO-Launch-Kit\.zip/);
assert.match(cardPage, /Fractional-CISO-Launch-Kit\.zip/);
assert.match(cardPage, /Fieldproof-Ethics-Check-Launch-Kit\.zip/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.doesNotMatch(shortPayPage, /http-equiv="refresh"/);
assert.doesNotMatch(shortPayPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/pay/', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
...
assert.doesNotMatch(freeOfferPage, /http-equiv="refresh"/);
assert.doesNotMatch(freeOfferPage, /location\.replace/);
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/robots.txt', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const robotsPage = await res.text();
assert.match(robotsPage, /Pay \$42 with card/);
assert.match(robotsPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(robotsPage, /http-equiv="refresh"/);
assert.doesNotMatch(robotsPage, /location\.replace/);
...
res = await call(freeEnv, 'GET', '/sitemap.xml', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const sitemapPage = await res.text();
assert.match(sitemapPage, /Pay \$42 with card/);
assert.match(sitemapPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(sitemapPage, /http-equiv="refresh"/);
assert.doesNotMatch(sitemapPage, /location\.replace/);
...
res = await call(freeEnv, 'GET', '/llms.txt', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const llmsPage = await res.text();
assert.match(llmsPage, /Pay \$42 with card/);
assert.match(llmsPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(llmsPage, /http-equiv="refresh"/);
assert.doesNotMatch(llmsPage, /location\.replace/);
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/llms-full.txt', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const llmsFullPage = await res.text();
assert.match(llmsFullPage, /Pay \$42 with card/);
assert.match(llmsFullPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(llmsFullPage, /http-equiv="refresh"/);
assert.doesNotMatch(llmsFullPage, /location\.replace/);
...
assert.doesNotMatch(wellKnownPayPage, /http-equiv="refresh"/);
assert.doesNotMatch(wellKnownPayPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/did.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const didPage = await res.text();
assert.match(didPage, /Pay \$42 with card/);
assert.match(didPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(didPage, /http-equiv="refresh"/);
assert.doesNotMatch(didPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/.well-known/did.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const wellKnownDidPage = await res.text();
assert.match(wellKnownDidPage, /Pay \$42 with card/);
assert.match(wellKnownDidPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(wellKnownDidPage, /http-equiv="refresh"/);
assert.doesNotMatch(wellKnownDidPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/.well-known/agent-card.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const agentCardPage = await res.text();
assert.match(agentCardPage, /Pay \$42 with card/);
assert.match(agentCardPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(agentCardPage, /http-equiv="refresh"/);
assert.doesNotMatch(agentCardPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/.well-known/agent.json');
assert.equal((await res.json()).card, card.card);
res = await call(freeEnv, 'GET', '/.well-known/agent.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const agentJsonPage = await res.text();
assert.match(agentJsonPage, /Pay \$42 with card/);
assert.match(agentJsonPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/openapi.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const openapiPage = await res.text();
assert.match(openapiPage, /Pay \$42 with card/);
assert.match(openapiPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(openapiPage, /http-equiv="refresh"/);
assert.doesNotMatch(openapiPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/.well-known/openapi.json');
assert.equal((await res.json()).externalDocs.url, spec.externalDocs.url);
res = await call(freeEnv, 'GET', '/.well-known/openapi.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /application\/json/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/.well-known/ai-plugin.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const aiPluginPage = await res.text();
assert.match(aiPluginPage, /Pay \$42 with card/);
assert.match(aiPluginPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(aiPluginPage, /http-equiv="refresh"/);
assert.doesNotMatch(aiPluginPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/.well-known/mcp.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const mcpJsonPage = await res.text();
assert.match(mcpJsonPage, /Pay \$42 with card/);
assert.match(mcpJsonPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(mcpJsonPage, /http-equiv="refresh"/);
assert.doesNotMatch(mcpJsonPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.doesNotMatch(homeHtml, /http-equiv="refresh"/);
assert.doesNotMatch(homeHtml, /location\.replace/);
...
assert.doesNotMatch(packPage, /http-equiv="refresh"/);
assert.doesNotMatch(packPage, /location\.replace/);
assert.match(packPage, /\/v1\/pay\/scan/);
assert.match(packPage, /target="_blank"/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/v1/pay/cfo');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const cfoPage = await res.text();
assert.match(cfoPage, /Pay \$42 with card/);
assert.match(cfoPage, /buy\.stripe\.com\/6oU28sa5Y9bLgTn9Lf1sQ01/);
assert.match(cfoPage, /Fractional-CFO-Launch-Kit\.zip/);
assert.doesNotMatch(cfoPage, /http-equiv="refresh"/);
assert.doesNotMatch(cfoPage, /location\.replace/);
assert.match(cfoPage, /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/v1/pay/cfo.uri');
assert.match(res.headers.get('content-type'), /text\/uri-list/);
assert.match(await res.text(), /buy\.stripe\.com\/6oU28sa5Y9bLgTn9Lf1sQ01/);
res = await call(freeEnv, 'GET', '/v1/pay/coo');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const cooPage = await res.text();
assert.match(cooPage, /Pay \$42 with card/);
assert.match(cooPage, /buy\.stripe\.com\/4gM7sM4LEafPcD72iN1sQ02/);
assert.match(cooPage, /Fractional-COO-Launch-Kit\.zip/);
assert.doesNotMatch(cooPage, /http-equiv="refresh"/);
assert.doesNotMatch(cooPage, /location\.replace/);
assert.match(cooPage, /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/v1/pay/coo.uri');
assert.match(res.headers.get('content-type'), /text\/uri-list/);
assert.match(await res.text(), /buy\.stripe\.com\/4gM7sM4LEafPcD72iN1sQ02/);
res = await call(freeEnv, 'GET', '/v1/pay/cto');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const ctoPage = await res.text();
assert.match(ctoPage, /Pay \$42 with card/);
assert.match(ctoPage, /buy\.stripe\.com\/6oU5kE91UbjTeLfg9D1sQ03/);
assert.match(ctoPage, /Fractional-CTO-Launch-Kit\.zip/);
assert.doesNotMatch(ctoPage, /http-equiv="refresh"/);
assert.doesNotMatch(ctoPage, /location\.replace/);
assert.match(ctoPage, /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/v1/pay/cto.uri');
assert.match(res.headers.get('content-type'), /text\/uri-list/);
assert.match(await res.text(), /buy\.stripe\.com\/6oU5kE91UbjTeLfg9D1sQ03/);
res = await call(freeEnv, 'GET', '/v1/pay/ciso');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const cisoPage = await res.text();
assert.match(cisoPage, /Pay \$42 with card/);
assert.match(cisoPage, /buy\.stripe\.com\/7sY14odia87H32xe1v1sQ04/);
assert.match(cisoPage, /Fractional-CISO-Launch-Kit\.zip/);
assert.doesNotMatch(cisoPage, /http-equiv="refresh"/);
assert.doesNotMatch(cisoPage, /location\.replace/);
assert.match(cisoPage, /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/v1/pay/ciso.uri');
assert.match(res.headers.get('content-type'), /text\/uri-list/);
assert.match(await res.text(), /buy\.stripe\.com\/7sY14odia87H32xe1v1sQ04/);
res = await call(freeEnv, 'GET', '/v1/pay/ethics');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const ethicsKitPage = await res.text();
assert.match(ethicsKitPage, /Pay \$42 with card/);
assert.match(ethicsKitPage, /buy\.stripe\.com\/aFa9AUce6afPdHb0aF1sQ05/);
assert.match(ethicsKitPage, /Fieldproof-Ethics-Check-Launch-Kit\.zip/);
assert.doesNotMatch(ethicsKitPage, /http-equiv="refresh"/);
assert.doesNotMatch(ethicsKitPage, /location\.replace/);
assert.match(ethicsKitPage, /\/v1\/pay\/scan/);
assert.doesNotMatch(ethicsKitPage, /Pythara/i);
res = await call(freeEnv, 'GET', '/v1/pay/ethics.uri');
assert.match(res.headers.get('content-type'), /text\/uri-list/);
assert.match(await res.text(), /buy\.stripe\.com\/aFa9AUce6afPdHb0aF1sQ05/);
...
assert.doesNotMatch(cmoPage, /http-equiv="refresh"/);
assert.doesNotMatch(cmoPage, /location\.replace/);
assert.match(cmoPage, /\/v1\/pay\/scan/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
assert.doesNotMatch(cmoPage, /Self-buys do not count/i);
res = await call(freeEnv, 'GET', '/v1/pay', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
...
assert.doesNotMatch(payIndex, /http-equiv="refresh"/);
assert.doesNotMatch(payIndex, /location\.replace/);
...
assert.match(payIndex, /C-suite Word kits live/);
assert.match(payIndex, /\/v1\/pay\/cfo/);
assert.match(payIndex, /\/v1\/pay\/coo/);
assert.match(payIndex, /\/v1\/pay\/cto/);
assert.match(payIndex, /\/v1\/pay\/ciso/);
assert.match(payIndex, /\/v1\/pay\/ethics/);
assert.doesNotMatch(payIndex, /operating contracts/);
assert.doesNotMatch(payIndex, /Self-buys do not count/i);
assert.doesNotMatch(payIndex, /\$59 Governance Pack/);
assert.match(payIndex, /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/v1/pay/scan');
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const scanPage = await res.text();
assert.match(scanPage, /Scan \$42/);
assert.match(scanPage, /42 USDC on Base/);
assert.match(scanPage, /bitcoin:bc1q/);
assert.match(scanPage, /3labsio@gmail.com/);
assert.match(scanPage, /create-qr-code/);
assert.doesNotMatch(scanPage, /http-equiv="refresh"/);
assert.doesNotMatch(scanPage, /location\.replace/);
assert.match(scanPage, /Pay \$42 with card/);
res = await call(freeEnv, 'GET', '/openapi.json');
assert.ok((await res.json()).paths['/v1/pay/scan'].get);
res = await call(freeEnv, 'GET', '/sitemap.xml');
assert.match(await res.text(), /\/v1\/pay\/scan/);
res = await call(freeEnv, 'GET', '/llms-full.txt');
assert.match(await res.text(), /\/v1\/pay\/scan/);
...
const listedScan = listed.checkouts.find((o) => o.id === 'scan-board');
assert.equal(listedScan.amount_usd, 42);
assert.match(listedScan.url, /\/v1\/pay\/scan$/);
...
const listedCfo = listed.checkouts.find((o) => o.id === 'cfo-kit');
assert.equal(listedCfo.amount_usd, 42);
assert.equal(listedCfo.meets_first_42, true);
assert.match(listedCfo.url, /\/v1\/pay\/cfo/);
assert.equal(listedCfo.pay_uri, 'https://buy.stripe.com/6oU28sa5Y9bLgTn9Lf1sQ01');
const listedCoo = listed.checkouts.find((o) => o.id === 'coo-kit');
assert.equal(listedCoo.amount_usd, 42);
assert.equal(listedCoo.meets_first_42, true);
assert.match(listedCoo.url, /\/v1\/pay\/coo/);
assert.equal(listedCoo.pay_uri, 'https://buy.stripe.com/4gM7sM4LEafPcD72iN1sQ02');
const listedCto = listed.checkouts.find((o) => o.id === 'cto-kit');
assert.equal(listedCto.amount_usd, 42);
assert.equal(listedCto.meets_first_42, true);
assert.match(listedCto.url, /\/v1\/pay\/cto/);
assert.equal(listedCto.pay_uri, 'https://buy.stripe.com/6oU5kE91UbjTeLfg9D1sQ03');
const listedCiso = listed.checkouts.find((o) => o.id === 'ciso-kit');
assert.equal(listedCiso.amount_usd, 42);
assert.equal(listedCiso.meets_first_42, true);
assert.match(listedCiso.url, /\/v1\/pay\/ciso/);
assert.equal(listedCiso.pay_uri, 'https://buy.stripe.com/7sY14odia87H32xe1v1sQ04');
const listedEthics = listed.checkouts.find((o) => o.id === 'ethics-kit');
assert.equal(listedEthics.amount_usd, 42);
assert.equal(listedEthics.meets_first_42, true);
assert.match(listedEthics.url, /\/v1\/pay\/ethics/);
assert.equal(listedEthics.pay_uri, 'https://buy.stripe.com/aFa9AUce6afPdHb0aF1sQ05');
...
assert.match(tip42.pay_uri, /tip-jar\?wanted=true/);
assert.doesNotMatch(tip42.pay_uri, /buy\.stripe\.com/);
assert.doesNotMatch(tip42.note, /auto-opens/);
...
assert.doesNotMatch(checkoutsPage, /http-equiv="refresh"/);
assert.doesNotMatch(checkoutsPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.doesNotMatch(tipPage, /http-equiv="refresh"/);
assert.doesNotMatch(tipPage, /location\.replace/);
assert.match(tipPage, /\/v1\/pay\/scan/);
...
assert.doesNotMatch(x402Page, /btn\.click\(\)/);
assert.doesNotMatch(x402Page, /location\.replace/);
assert.doesNotMatch(x402Page, /http-equiv="refresh"/);
...
assert.doesNotMatch(offerPage, /http-equiv="refresh"/);
assert.doesNotMatch(offerPage, /location\.replace/);
res = await call(sponsorEnv, 'GET', '/v1/sponsor');
assert.strictEqual(res.status, 200, 'GET /v1/sponsor without HTML Accept documents 42 USDC plus card fallback');
const defaultSponsor = await res.json();
assert.equal(defaultSponsor.price_usd, 42);
...
assert.strictEqual(res.status, 200, 'generic Accept still documents, not HTML');
res = await call(sponsorEnv, 'GET', '/v1/sponsor', undefined, { accept: 'application/json' });
assert.strictEqual(res.status, 200, 'unpaid GET /v1/sponsor with JSON Accept documents the 42 USDC quote');
...
assert.doesNotMatch(sponsorPage, /http-equiv="refresh"/);
...
assert.doesNotMatch(payPage, /btn\.click\(\)/);
assert.doesNotMatch(payPage, /location\.replace/);
...
assert.match(payPage, /\/v1\/pay\/scan/);
assert.match(payPage, /agentic-ai-governance-pack\?wanted=true/);
...
assert.doesNotMatch(zellePage, /http-equiv="refresh"/);
assert.doesNotMatch(zellePage, /location\.replace/);
assert.match(zellePage, /create-qr-code/);
assert.match(zellePage, /\/v1\/pay\/scan/);
assert.match(zellePage, /agentic-ai-governance-pack\?wanted=true/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.doesNotMatch(btcPage, /http-equiv="refresh"/);
assert.doesNotMatch(btcPage, /location\.replace/);
assert.doesNotMatch(btcPage, /Mobi\|Android\|iPhone\|iPad/);
assert.match(btcPage, /\/v1\/pay\/scan/);
assert.match(btcPage, /agentic-ai-governance-pack\?wanted=true/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.doesNotMatch(invoicePage, /http-equiv="refresh"/);
assert.doesNotMatch(invoicePage, /location\.replace/);
...
assert.match(skill, /\/v1\/pay\/usdc\.png/);
assert.match(skill, /\/v1\/pay\/btc\.png/);
assert.match(skill, /\/v1\/pay\/zelle\.png/);
assert.match(skill, /\/v1\/pay\/scan/);
assert.match(skill, /\/v1\/invoice/);
assert.match(skill, /first_42_sponsor/);
assert.match(skill, /\/v1\/pay\/pack\.uri/);
assert.match(skill, /\/v1\/pay\/tip-jar\.uri/);
assert.doesNotMatch(skill, /auto-opens Stripe/);
assert.doesNotMatch(skill, /Self-buys do not count/i);
res = await call(freeEnv, 'GET', '/skills/pay/SKILL.md', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const skillPage = await res.text();
assert.match(skillPage, /Pay \$42 with card/);
assert.match(skillPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(skillPage, /http-equiv="refresh"/);
assert.doesNotMatch(skillPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/.well-known/skills/pay/SKILL.md', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/markdown/);
assert.match(await res.text(), /name: fieldproof-pay-42/);
...
res = await call(freeEnv, 'GET', '/skills.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const skillsPage = await res.text();
assert.match(skillsPage, /Pay \$42 with card/);
assert.match(skillsPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(skillsPage, /http-equiv="refresh"/);
assert.doesNotMatch(skillsPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/.well-known/skills.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /application\/json/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.doesNotMatch(npmPkgPage, /http-equiv="refresh"/);
assert.doesNotMatch(npmPkgPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
res = await call(freeEnv, 'GET', '/');
...
assert.match(packInvoice.gumroad, /agentic-ai-governance-pack\?wanted=true/);
assert.match(packInvoice.card, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.match(tipInvoice.gumroad, /tip-jar\?wanted=true/);
assert.match(tipInvoice.card, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.match(await res.text(), /mailto:3labsio@gmail.com/);
res = await call(freeEnv, 'GET', '/security.txt', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const securityPage = await res.text();
assert.match(securityPage, /Pay \$42 with card/);
assert.match(securityPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(securityPage, /http-equiv="refresh"/);
assert.doesNotMatch(securityPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
res = await call(freeEnv, 'GET', '/humans.txt', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const humansPage = await res.text();
assert.match(humansPage, /Pay \$42 with card/);
assert.match(humansPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(humansPage, /http-equiv="refresh"/);
assert.doesNotMatch(humansPage, /location\.replace/);
...
res = await call(freeEnv, 'GET', '/.well-known/webfinger', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const webfingerPage = await res.text();
assert.match(webfingerPage, /Pay \$42 with card/);
assert.match(webfingerPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(webfingerPage, /http-equiv="refresh"/);
assert.doesNotMatch(webfingerPage, /location\.replace/);
...
res = await call(freeEnv, 'GET', '/.well-known/host-meta', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const hostMetaPage = await res.text();
assert.match(hostMetaPage, /Pay \$42 with card/);
assert.match(hostMetaPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(hostMetaPage, /http-equiv="refresh"/);
assert.doesNotMatch(hostMetaPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
res = await call(freeEnv, 'GET', '/.well-known/nodeinfo', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const nodeinfoPage = await res.text();
assert.match(nodeinfoPage, /Pay \$42 with card/);
assert.match(nodeinfoPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(nodeinfoPage, /http-equiv="refresh"/);
assert.doesNotMatch(nodeinfoPage, /location\.replace/);
...
res = await call(freeEnv, 'GET', '/nodeinfo/2.1', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const node21Page = await res.text();
assert.match(node21Page, /Pay \$42 with card/);
assert.match(node21Page, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/.well-known/nodeinfo/2.1');
assert.equal((await res.json()).metadata.payment, node.metadata.payment);
res = await call(freeEnv, 'GET', '/.well-known/nodeinfo/2.1', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const wellKnownNode21Page = await res.text();
assert.match(wellKnownNode21Page, /Pay \$42 with card/);
assert.match(wellKnownNode21Page, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(wellKnownNode21Page, /http-equiv="refresh"/);
assert.doesNotMatch(wellKnownNode21Page, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.doesNotMatch(quotePage, /http-equiv="refresh"/);
assert.doesNotMatch(quotePage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
res = await call(freeEnv, 'GET', '/v1/pay/btc.png');
assert.strictEqual(res.status, 302);
const btcQrLoc = res.headers.get('location') || '';
assert.match(btcQrLoc, /qrserver\.com\/v1\/create-qr-code/);
assert.match(btcQrLoc, /bitcoin%3Abc1q|bitcoin:bc1q/);
assert.match(btcQrLoc, /bc1qxwjhlllya7yvh0kvfggrjfzxwme7zhqs07777t/);
res = await call(freeEnv, 'GET', '/v1/pay/btc.qr');
assert.strictEqual(res.status, 302);
assert.match(res.headers.get('location') || '', /bitcoin/);
res = await call(freeEnv, 'GET', '/openapi.json');
assert.ok((await res.json()).paths['/v1/pay/btc.png'].get);
const listedBtcQr = listed.checkouts.find((o) => o.id === 'bitcoin-qr');
assert.equal(listedBtcQr.amount_usd, 42);
assert.match(listedBtcQr.url, /\/v1\/pay\/btc\.png$/);
assert.match(listedBtcQr.qr_url, /qrserver\.com/);
res = await call(freeEnv, 'GET', '/llms-full.txt');
assert.match(await res.text(), /\/v1\/pay\/btc\.png/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
assert.match(await res.text(), /\/v1\/pay\/btc\.png/);
assert.match(payManifest.also.btc_qr, /\/v1\/pay\/btc\.png$/);
res = await call(freeEnv, 'GET', '/v1/pay/zelle.png');
assert.strictEqual(res.status, 302);
const zelleQrLoc = res.headers.get('location') || '';
assert.match(zelleQrLoc, /qrserver\.com\/v1\/create-qr-code/);
assert.match(zelleQrLoc, /mailto%3A3labsio|mailto:3labsio/);
res = await call(freeEnv, 'GET', '/v1/pay/zelle.qr');
assert.strictEqual(res.status, 302);
assert.match(res.headers.get('location') || '', /3labsio/);
res = await call(freeEnv, 'GET', '/openapi.json');
assert.ok((await res.json()).paths['/v1/pay/zelle.png'].get);
const listedZelleQr = listed.checkouts.find((o) => o.id === 'zelle-qr');
assert.equal(listedZelleQr.amount_usd, 42);
assert.match(listedZelleQr.url, /\/v1\/pay\/zelle\.png$/);
res = await call(freeEnv, 'GET', '/llms-full.txt');
assert.match(await res.text(), /\/v1\/pay\/zelle\.png/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
assert.match(await res.text(), /\/v1\/pay\/zelle\.png/);
assert.match(payManifest.also.zelle_qr, /\/v1\/pay\/zelle\.png$/);
...
res = await call(freeEnv, 'GET', '/.well-known/host-meta.json', undefined, { accept: 'text/html' });
assert.strictEqual(res.status, 200);
assert.match(res.headers.get('content-type'), /text\/html/);
const hostMetaJsonPage = await res.text();
assert.match(hostMetaJsonPage, /Pay \$42 with card/);
assert.match(hostMetaJsonPage, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
assert.doesNotMatch(hostMetaJsonPage, /http-equiv="refresh"/);
assert.doesNotMatch(hostMetaJsonPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.deepStrictEqual((await res.json()).policies, ['default-action-tiers', 'default-action-tiers-capped']);
...
assert.doesNotMatch(wellKnownX402Page, /http-equiv="refresh"/);
assert.doesNotMatch(wellKnownX402Page, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.doesNotMatch(mcpPage, /http-equiv="refresh"/);
assert.doesNotMatch(mcpPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.match(canonsPage, /Pay \$42 for the Ethics Check kit/);
...
assert.match(ethicsPage, /Pay \$42 for the Ethics Check kit/);
