...
assert.match(cfoPage, /http-equiv="refresh"/);
assert.match(cfoPage, /location\.replace/);
...
assert.match(cooPage, /http-equiv="refresh"/);
assert.match(cooPage, /location\.replace/);
...
assert.match(ctoPage, /http-equiv="refresh"/);
assert.match(ctoPage, /location\.replace/);
...
assert.match(cisoPage, /http-equiv="refresh"/);
assert.match(cisoPage, /location\.replace/);
...
assert.match(ethicsKitPage, /http-equiv="refresh"/);
assert.match(ethicsKitPage, /location\.replace/);
