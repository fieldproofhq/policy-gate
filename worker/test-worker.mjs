...
assert.match(robotsPage, /http-equiv="refresh"/);
assert.match(robotsPage, /location\.replace/);
...
assert.match(sitemapPage, /http-equiv="refresh"/);
assert.match(sitemapPage, /location\.replace/);
...
assert.match(llmsPage, /http-equiv="refresh"/);
assert.match(llmsPage, /location\.replace/);
...
assert.match(llmsFullPage, /http-equiv="refresh"/);
assert.match(llmsFullPage, /location\.replace/);
...
assert.match(didPage, /http-equiv="refresh"/);
assert.match(didPage, /location\.replace/);
...
assert.match(wellKnownDidPage, /http-equiv="refresh"/);
assert.match(wellKnownDidPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(agentCardPage, /http-equiv="refresh"/);
assert.match(agentCardPage, /location\.replace/);
...
assert.match(openapiPage, /http-equiv="refresh"/);
assert.match(openapiPage, /location\.replace/);
...
assert.match(aiPluginPage, /http-equiv="refresh"/);
assert.match(aiPluginPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(mcpJsonPage, /http-equiv="refresh"/);
assert.match(mcpJsonPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/sitemap.xml');
...
assert.match(skillPage, /http-equiv="refresh"/);
assert.match(skillPage, /location\.replace/);
assert.match(res.headers.get('link') || '', /rel="payment"/);
...
assert.match(skillsPage, /http-equiv="refresh"/);
assert.match(skillsPage, /location\.replace/);
...
assert.equal(tipInvoice.scheme, 'stripe');
assert.equal(tipInvoice.amountUsd, 42);
assert.match(tipInvoice.uri, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
...
assert.match(listedTipUri.pay_uri, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/llms-full.txt');
...
assert.match(securityPage, /http-equiv="refresh"/);
assert.match(securityPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.match(humansPage, /http-equiv="refresh"/);
assert.match(humansPage, /location\.replace/);
...
assert.match(webfingerPage, /http-equiv="refresh"/);
assert.match(webfingerPage, /location\.replace/);
...
assert.match(hostMetaPage, /http-equiv="refresh"/);
assert.match(hostMetaPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.match(nodeinfoPage, /http-equiv="refresh"/);
assert.match(nodeinfoPage, /location\.replace/);
...
assert.match(wellKnownNode21Page, /http-equiv="refresh"/);
assert.match(wellKnownNode21Page, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
...
assert.match(hostMetaJsonPage, /http-equiv="refresh"/);
assert.match(hostMetaJsonPage, /location\.replace/);
res = await call(freeEnv, 'GET', '/openapi.json');
