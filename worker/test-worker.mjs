...
assert.equal(packInvoice.scheme, 'stripe');
assert.equal(packInvoice.amountUsd, 42);
assert.match(packInvoice.uri, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
...
assert.match(listedPackUri.pay_uri, /buy\.stripe\.com\/eVq4gA91U3Rr1Yt6z31sQ00/);
res = await call(freeEnv, 'GET', '/llms-full.txt');
